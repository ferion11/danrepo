...
CHROMIUM_LANGS="af am ar az bg bn ca cs da de el en-GB en-US es es-419 et fa fi fil fr
	gu he hi hr hu id it ja ka kk km kn ko lo lt lv mk ml mn mr ms my nb nl pl pt-BR pt-PT ro ru si sk
	sl sq sr sr-Latn sv sw ta te th tr uk ur uz vi zh-CN zh-TW"
...
src_install() {
	...
	sed -i '/\[Desktop Action new-private-window\]/,/^\[/ s/^NoDisplay=/X-NoDisplay=/' usr/share/applications/com.brave.Browser.desktop
